...
--- Create user command for toggle w3m usage
vim.api.nvim_create_user_command("WebsearchUseW3m", function()
    config.use_w3m = not config.use_w3m
    print("Use w3m: " .. tostring(config.use_w3m))
end, {})
